# Sprint T iter 37 Phase 3 fix — R7 Stress (INTENT exec rate) 2026-04-30T18-57-41-337Z
...
| Successful | 200/200 | — | — |
| Failures | 0 | — | — |
| Canonical `intents_parsed` (≥1 valid) | 0 | — | — |
| Legacy `[AZIONE:...]` only | 84 | — | — |
| No actionable signal | 116 | — | — |
| **Canonical INTENT exec rate** | **0.0%** | ≥80% | **FAIL** |
| Combined (canonical + legacy AZIONE) | 42.0% | ≥80% | FAIL |

## Intent quality (across all canonical intents seen)

| Metric | Count | % |
|--------|-------|---|
| Total intents emitted | 0 | — |
| Shape valid (tool + args) | 0 | 0.0% |
| Whitelist match | 0 | 0.0% |
| Params shape valid | 0 | 0.0% |
...
- **Canonical INTENT exec rate**: 0.0% (target ≥80%)
- **Combined rate**: 42.0%
- **Verdict**: FAIL

## Files

- Raw responses: scripts/bench/output/r7-stress-responses-2026-04-30T18-57-41-337Z.jsonl
- Scorer JSON: scripts/bench/output/r7-stress-scores-2026-04-30T18-57-41-337Z.json
- This report: scripts/bench/output/r7-stress-report-2026-04-30T18-57-41-337Z.md
