...
const data = await page.evaluate(() => {
  ...
  return {
    ...
    controls: controls.slice(0, 350),
    bodySnippet: compact(document.body.innerText || '').slice(0, 1000),
  };
});

console.log(JSON.stringify(data, null, 2));
await page.screenshot({ path: '/tmp/session61_after_login_probe.png', fullPage: true });
await browser.close();
