...
void loop() {
  ...
  analogWrite(A0, valoreLetto);
      ...
      hwOnly: true,
      hwOnlyMessage: "Questo esperimento usa il DAC reale del Nano R4 (analogWriteResolution 10 bit). L'emulatore ATmega328p non supporta il DAC hardware — provalo con la scheda fisica!",
      layer: "schema",
      steps: [
