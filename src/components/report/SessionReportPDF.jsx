...
export async function generateSessionReportPDF(sessionData, circuitScreenshot, aiSummary, timeline = [], measurements = null) {
  ...
  const st = R.StyleSheet.create({
    ...
    coverDate: { fontSize: 11, color: '#525252', textAlign: 'center', marginTop: 16 },
    ...
    narrativeItalic: { fontSize: 9, fontStyle: 'italic', color: '#525252', marginBottom: 8 },
    ...
    chatRoleStudent: { fontFamily: 'Oswald', fontSize: 8, fontWeight: 700, color: '#525252', marginBottom: 2, textAlign: 'right' },
