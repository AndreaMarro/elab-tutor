...
/**
 * GalileoResponsePanel — Modal overlay showing Galileo AI response
 * Design: Apple card-style modal with Galileo branding
...
const GalileoResponsePanel = React.memo(function GalileoResponsePanel({
  response,
  isAsking,
  onAskAgain,
  onClose,
...
// ─── Styles (Apple card modal with Galileo branding — uses design-system tokens) ───
const S = {
  backdrop: {
    position: 'fixed',
    top: 0,
...
export default GalileoResponsePanel;
