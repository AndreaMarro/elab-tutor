    ...
    <div className={ovStyles.backdrop} onClick={onClose}>
      <div className={ovStyles.card} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={ovStyles.valueRow}>
          <span style={{ fontSize: 14, color: 'var(--color-text-gray-300, #888)', width: 36 }}>Buio</span>
          <input
            type="range"
            min="0"
            max="1000"
          ...
          />
          <span style={{ fontSize: 14, color: 'var(--color-text-gray-300, #888)', width: 36, textAlign: 'right' }}>Luce</span>
        </div>
        <div style={{ textAlign: 'center', fontSize: 14, color: 'var(--color-text-gray-400, #666)', padding: '0 0 6px' }}>
          ~{luxApprox} lux
        </div>
      </div>
    </div>
