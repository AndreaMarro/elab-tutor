...
const TABS = [
    ...
    { id: 'utenti',      label: 'Utenti',       icon: <IconUsers />, color: '#7CB342' },
            ...
            <div style={{ background: '#F0F4F8', minHeight: 'calc(100vh - 56px)' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{
                            background: connectionStatus?.connected ? '#7CB342' : '#EF4444',
                ...
                <div style={{
                    ...
                    <div style={{ marginTop: '12px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <span style={{
                            ...
                            background: connectionStatus?.connected ? '#7CB342' : connectionStatus === null ? '#F59E0B' : '#EF4444',
