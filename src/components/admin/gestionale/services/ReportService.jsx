...
function getStyles() {
    ...
    s = StyleSheet.create({
        ...
        title: { fontSize: 18, fontWeight: 'bold', color: '#1E4D8C', marginBottom: 4 },
        subtitle: { fontSize: 10, color: '#64748B', marginBottom: 2 },
        divider: { height: 2, backgroundColor: '#1E4D8C', marginVertical: 10 },
        ...
        summaryLabel: { fontSize: 11, fontWeight: 'bold', color: '#1E4D8C' },
        summaryValue: { fontSize: 11, fontWeight: 'bold', color: '#1E4D8C' },
